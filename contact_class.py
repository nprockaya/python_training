class Contact:
    def __init__(self, first_name_value, middle_name_value, last_name_value, nickname_value, title_value, company_value, address_value, home_phone_value, mobile_phone_value, work_phone_value, fax_value, email_value, email2_value, email3_value, homepage_value, birthday_value, anniversary_value, secondary_address_value, secondary_home_value, secondary_notes_value):
        ...
        self.anniversary = anniversary_value
